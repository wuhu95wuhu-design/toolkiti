    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <section className="mb-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
          ...
          <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-3 text-center"><div className="text-xl font-bold text-[var(--accent)]">{apis.length}+</div><div className="text-xs text-[var(--muted)]">Code Examples</div></div>
