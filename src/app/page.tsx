    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <section className="mb-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
          <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-3 text-center"><div className="text-xl font-bold text-[var(--accent)]">41</div><div className="text-xs text-[var(--muted)]">APIs Listed</div></div>
          <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-3 text-center"><div className="text-xl font-bold text-[var(--accent)]">9</div><div className="text-xs text-[var(--muted)]">Categories</div></div>
          <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-3 text-center"><div className="text-xl font-bold text-[var(--accent)]">41+</div><div className="text-xs text-[var(--muted)]">Code Examples</div></div>
        ...
        <section className="mb-8 rounded-lg border border-[var(--border)] bg-[var(--card)] p-6 text-center">
          ...
          <p className="mb-4 text-sm text-[var(--muted)]">Request a new API or tool to be added to ToolKiti.</p>
          <a href="https://github.com/wuhu95wuhu-design/toolkiti/issues/new?labels=api-request&template=api_request.md&title=Request: " target="_blank" rel="noopener noreferrer"
        ...
        <section className="mt-16 border-t border-[var(--border)] pt-8">
          ...
          <div className="mt-3 flex flex-wrap gap-x-3 gap-y-1 text-sm">
            ...
            <a href="/opensearch.xml" className="underline">opensearch.xml</a>
          </div>
        </section>
